...
#
#def step4(request, step=1):
#    if request.method == 'POST':
#        step = int(request.POST['step'])
#        if step == 1:
#            form = Step4Form1(request.POST)
#            if form.is_valid():
#                print 'valid'
#                request.session['s4_data1'] = _s4_read_data1(form.cleaned_data)
#
#                s4_data2 = request.session.get('s4_data2')
#                initial_data = {}
#                if s4_data2:
#                    initial_data = s4_data2
#                form = Step4Form2()
#                return direct_to_template(request,'calc/step4_2.html', {'form':form}) #redirect(reverse('ncalc_step4', args=[2] ))
#        elif step == 2:
#            form = Step4Form2(request.POST)
#            if form.is_valid():
#                print 'valid'
#                #request.session['s4_data2'] = _s4_read_data1(form.cleaned_data)
#
#                s4_data2 = request.session.get('s4_data2')
#                initial_data = {}
#                if s4_data2:
...
#        initial_data = {}
#        if int(step) == 1:
#            s4_data1 = request.session.get('s4_data1')
#            if s4_data1:
#                initial_data = s4_data1
#            form = Step4Form1(initial = initial_data)
#        elif int(step) == 2:
#            s4_data2 = request.session.get('s4_data2')
#            if s4_data2:
#                initial_data = s4_data2
#            form = Step4Form2(initial = initial_data)
#        return direct_to_template(request, 'calc/step4noreg.html', {"form": form})
#
#
#def _s4_read_data1(cd):
#    s4_data1 = {}
#    s4_data1['first_name'] = cd['first_name']
#    s4_data1['last_name'] = cd['last_name']
#    s4_data1['middle_name'] = cd['middle_name']
#    s4_data1['birth_date'] = cd['birth_date']
#    s4_data1['category'] = cd['category']
#    s4_data1['sex'] = cd['sex']
#
#    s4_data1['citizenship'] = cd['citizenship']
#    s4_data1['passport_series'] = cd['passport_series']
#    s4_data1['passport_number'] = cd['passport_number']
#    s4_data1['issued_org'] = cd['issued_org']
#    s4_data1['issued_date'] = cd['issued_date']
#
#    s4_data1['reg_region'] = cd['reg_region']
#    s4_data1['reg_area'] = cd['reg_area']
#    s4_data1['reg_city'] = cd['reg_city']
#    s4_data1['reg_street'] = cd['reg_street']
#    s4_data1['reg_index'] = cd['reg_index']
#    s4_data1['reg_building'] = cd['reg_building']
#    s4_data1['reg_housing'] = cd['reg_housing']
#    s4_data1['reg_flat'] = cd['reg_flat']
#
#    s4_data1['live_region'] = cd['live_region']
#    s4_data1['live_area'] = cd['live_area']
#    s4_data1['live_city'] = cd['live_city']
#    s4_data1['live_street'] = cd['live_street']
#    s4_data1['live_index'] = cd['live_index']
#    s4_data1['live_building'] = cd['live_building']
#    s4_data1['live_housing'] = cd['live_housing']
#    s4_data1['live_flat'] = cd['live_flat']
#
#    return s4_data1
#
#def step4(request):
...
#        else:
#            form = Step4Form1NoReg(request.POST)
#            if form.is_valid():
#                cd = form.cleaned_data
#                s1_data = request.session.get("s1_data")
#                ip = InsurancePolicy()
